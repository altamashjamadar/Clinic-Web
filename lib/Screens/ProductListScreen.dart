...
//   //     const SnackBar(content: Text('This product is unavailable')),
//   //   );
//   //   return;
//   // }
...
// // ask user for quantity (1..available)
...
//         ElevatedButton(onPressed: () => Navigator.pop(ctx, qty), child: const Text('Add'))
//       ],
//     ),
//   );
// }
...
//       // 1) READS: read product and cart first
...
//       // 2) WRITES: now perform updates (all reads done)
