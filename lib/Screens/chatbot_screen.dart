...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  final List<String> messages = [
    'Bot: Hi! 👋 I’m your health assistant. How can I help you today?',
  ];
  ...
  final Map<String, String> answers = {
    ...
    'Warning signs':
        'Severe cramps, bleeding, or dizziness need immediate care 🚨.',
    'Herbal supplements':
        'We provide 100% pure herbal supplements 🌱.',
    'Lifestyle guidance':
        'Balanced sleep, meditation, and yoga help maintain health.',
    'Consult a doctor':
  ...
  void _sendResponse(String response) {
    setState(() {
      ...
      if (level == 3) {
        messages.add('Bot: You can book an appointment anytime below 📅');
      }
    });
